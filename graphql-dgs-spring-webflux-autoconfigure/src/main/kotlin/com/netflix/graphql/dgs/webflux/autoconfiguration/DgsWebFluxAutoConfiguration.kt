...
import com.netflix.graphql.dgs.internal.ArgumentResolver
...
import com.netflix.graphql.dgs.reactive.internal.HandlerMethodArgumentResolverAdapter
...
open class DgsWebFluxAutoConfiguration(private val configProps: DgsWebfluxConfigurationProperties) {
    ...
    open class WebFluxArgumentHandlerConfiguration {
        ...
        open fun cookieValueArgumentResolver(
            ...
            return HandlerMethodArgumentResolverAdapter(CookieValueMethodArgumentResolver(beanFactory, registry), bindingContext)
        }
        ...
        open fun requestHeaderMapArgumentResolver(registry: ReactiveAdapterRegistry, @Dgs bindingContext: BindingContext): ArgumentResolver {
            return HandlerMethodArgumentResolverAdapter(RequestHeaderMapMethodArgumentResolver(registry), bindingContext)
        }
        ...
        open fun requestHeaderArgumentResolver(
            ...
            return HandlerMethodArgumentResolverAdapter(RequestHeaderMethodArgumentResolver(beanFactory, registry), bindingContext)
        }
        ...
        open fun requestParamMapArgumentResolver(
            ...
            return HandlerMethodArgumentResolverAdapter(RequestParamMapMethodArgumentResolver(registry), bindingContext)
        }
    }
}
